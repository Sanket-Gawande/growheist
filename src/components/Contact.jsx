...
const Contact = () => {
  return (
    <div className="min-h-screen md:bg-purple-50 flex flex-col md:flex-row items-center justify-center">
      <div className="md:min-h-[400px] h-full">
        <img
          className="w-full md:h-[450px] block mx-auto md:mx-0"
      ...
      <div className="h-full min-h-[450px] w-full  px-4 mx-auto md:mx-0  md:w-[450px] bg-white py-8 pX-8">
        <form>
